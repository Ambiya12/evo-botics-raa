                                ...
                                <div className="p-6 text-gray-900">
                                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                        <div className="flex items-center gap-4">
                                            <div className={`flex h-12 w-12 items-center justify-center rounded-full ${item.status === 'confirmed' ? 'bg-green-100' :
                                                item.status === 'pending' ? 'bg-yellow-100' :
                                                    item.status === 'cancelled' ? 'bg-red-100' : 'bg-gray-100'
                                                }`}>
                                                <svg className={`h-6 w-6 ${item.status === 'confirmed' ? 'text-green-600' :
